...
import { removeSpecialCharactersFromString, formatedPhone, formatedIe, formatedZipCode } from '../utilities/fakes'
import {
...
describe('Office', function() {
  ...
  describe('Update', function() {
    ...
    it('Should update the just created company', async function() {
      // Arrange
      const postResponse = await request(app)
        .post('/api/crud/offices')
        .send({
