...
import { CreateCrudUseCase, AfterCreateCrudUseCase } from '@/domain/features/'
...
export class CreateCrudUseCaseImpl<RequestDTO, ResponseDTO>
implements CreateCrudUseCase<RequestDTO, ResponseDTO> {
